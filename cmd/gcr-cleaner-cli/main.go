...
var (
	...
	excludeTagFilterAll = flag.String("exclude-tag-filter-any", "", "Delete images where any tag DOESN'T matches this regular expression")
...
func realMain(ctx context.Context, logger *gcrcleaner.Logger) error {
	...
	tagFilter, err := gcrcleaner.BuildTagFilter(*tagFilterAny, *tagFilterAll, *excludeTagFilterAll)
	if err != nil {
